...
def generate_proof_concept_images():
    ...
    print("🚀 Generating 3 Proof-of-Concept Images...")
    print("=" * 50)
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                if data.get('success'):
                    ...
                    print(f"❌ Error generating image {i}: {data.get('error', 'Unknown error')}")
            else:
    ...
    print("\n" + "=" * 50)
    print("🎉 Proof-of-concept generation complete!")
...
if __name__ == "__main__":
    print("🔧 Giramille Style Proof-of-Concept Generator")
    print("=" * 50)
